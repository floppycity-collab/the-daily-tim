...
channel_ids = {'Timmy_playz45': 'UC-s341sjpNOz3jxSwfKis6w'}  
...
async def create_webhook(title, link, youtube_name, date):
    async with aiohttp.ClientSession() as session:
        ...
        webhook_username = "The Daily Tim" # enter name of the Webhook user, can be anything (in this case, it's YouTube Bot)
        webhook_avatar = "https://i.imgur.com/UtSQiYm.png" # enter a url to a pic if you want a avatar
